...
<body>
    ...
    <div class="header">
      ...
      <div class="dl-title">
          <span class="lp-title-port"></span><span class="dl-title-text">门诊就医管理系统 (挂号管理员)</span>
      </div>
   ...
   <div class="content">
    <div class="dl-main-nav">
      ...
      <ul id="J_Nav"  class="nav-list ks-clear">
        ...
        <li class="nav-item"><div class="nav-item-inner nav-order">挂号情况</div></li>
      ...
      var config = [{
          ...
          //{
            ...
            menu:[{
                text:'挂号情况',
                items:[
                  {id:'code',text:'挂号查询',href:'call/search.aspx'},
                  {id:'example',text:'等待人数',href:'call/waiting.aspx'},
