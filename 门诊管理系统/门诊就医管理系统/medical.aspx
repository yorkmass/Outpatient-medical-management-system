...
<body>
    ...
    <div class="header">
      ...
      <div class="dl-title">
          <span class="lp-title-port"></span><span class="dl-title-text">门诊就医管理系统 (药房管理员)</span>
      </div>
   ...
   <div class="content">
    <div class="dl-main-nav">
      ...
      <ul id="J_Nav"  class="nav-list ks-clear">
        ...
        <li class="nav-item"><div class="nav-item-inner nav-order">药材管理</div></li>
      ...
      var config = [{
          ...
          //{
            ...
            menu:[{
                text:'药材管理',
                items:[
                  {id:'code',text:'药品清单',href:'medical/list.aspx'},
                  {id:'example',text:'用药记录',href:'medical/record.aspx'},
            ...
            menu:[{
                text:'库存管理',
                items:[
                  {id:'code',text:'药品库存',href:'medical/last.aspx'},
